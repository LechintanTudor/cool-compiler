...
pub const EXTENSION: &str = "cool";
pub const DIR_MODULE_NAME: &str = "@module.cool";

#[derive(Clone, Error, Display, Debug)]
pub enum ModulePathsError {
    #[display("No module path found")]
    NoPathFound,

    #[display("Multiple module paths found")]
    MultiplePathsFound,

    #[display("Bad file extension")]
    BadExtension,
}
